...
public class Build {
    ...
    public static final String CLOWN_VERSION = getString("ro.clown.version");

    /** A build ID string meant for displaying to the user */
    public static final String CLOWN_DISPLAY_VERSION = getString("ro.clown.display.version");
